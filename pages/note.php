...
<?php
//**********************************liste*********************** */
$res=$connexion->prepare("SELECT libelle_matiere, note FROM note n, matiere m WHERE n.code_matiere=m.code_matiere and Annee_scolaire=2024 and n.ID_eleve='$id' and n.code_T=3");
$res->execute();
$somme=0;
$coef=0;
...
<br> <a href="elevee.php"><h3>Retour</h3></a>
</body>
</html>